...
<head>
    ...
    <style>
    .bg {
        background-image: url(<?php echo base_url("assets/images/bidding-bg1.jpg");
        ?>);
    ...
    <div class="section bg">
        <div class="container">
            <div class="row full-height justify-content-center">
				...
				<img class='login-image' src=<?php echo base_url("assets/images/logo2.png");?> >
											...
											<div class="section text-center">
												...
												<div class="form-group">
													<input type="text" name="name" class="form-style"
														placeholder="Your Full Name" id="logname" autocomplete="off" required>
                                                ...
                                                <div class="form-group mt-2">
                                                    <select name="position" class="form-style" placeholder="Position" required>
                                                        <option value="AUCTIONER">SELECT POSITION</option>
